...
async def gay(ctx):
    ...
    todd = await bot.fetch_user(231437641478963200)
    KappaPride = bot.get_emoji(449082148415078401)
    await ctx.send(str(chase.mention) + " " + str(todd.mention) + " Chase and Todd are gay " + str(KappaPride))


# prints when the bot has been disconnected
@bot.event
